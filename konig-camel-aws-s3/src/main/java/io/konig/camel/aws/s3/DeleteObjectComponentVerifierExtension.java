...
public class DeleteObjectComponentVerifierExtension extends DefaultComponentVerifierExtension {

    public DeleteObjectComponentVerifierExtension() {
    	 this("konig-aws-s3");
    }

    public DeleteObjectComponentVerifierExtension(String scheme) {
        super(scheme);
    }
