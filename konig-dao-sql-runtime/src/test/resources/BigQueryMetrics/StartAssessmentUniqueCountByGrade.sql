...
split(locationType,':')[OFFSET(7)] as grade,
assessmentType,
STRUCT( "http://www.w3.org/2006/time#unitMonth" as durationUnit,
TIMESTAMP(CONCAT(CAST(year As String),"-",CAST(month As String) ,"-01")) as intervalStart),   
uniqueCount	
from(
