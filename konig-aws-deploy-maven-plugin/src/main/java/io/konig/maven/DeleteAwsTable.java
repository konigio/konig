 ...
 *
 */
public class DeleteAwsTable 
{
	private AwsDeployment deployment;

	public DeleteAwsTable(AwsDeployment deployment) {
	...
	public AwsDeployment from(String path) throws Exception {
		...
		System.out.println("INSIDE DELETE FROM");
		try {
			...
			deployment.setResponse("Deleted Table " + tableId);
