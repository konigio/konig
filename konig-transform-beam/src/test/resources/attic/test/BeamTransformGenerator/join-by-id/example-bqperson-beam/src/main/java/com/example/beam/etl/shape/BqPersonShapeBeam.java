...
public class BqPersonShapeBeam {
    ...
    public static void process(BqPersonShapeBeam.Options options) {
        ...
        PCollection<KV<String, CoGbkResult>> kvpCollection = KeyedPCollectionTuple.of(personNameTag, personName).and(personAlumniOfTag, personAlumniOf).apply(CoGroupByKey.<String> create());
        TableRow<TableRow> outputRowCollection = kvpCollection.apply(ParDo.of(new MergePersonNameAndPersonAlumniOfFn()));
