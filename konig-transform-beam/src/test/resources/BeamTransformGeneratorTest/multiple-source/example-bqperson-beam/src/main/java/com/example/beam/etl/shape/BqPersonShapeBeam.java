...
public class BqPersonShapeBeam {
    ...
    public static void process(BqPersonShapeBeam.Options options) {
        ...
        PCollection<KV<String, CoGbkResult>> kvpCollection = KeyedPCollectionTuple.of(personContactTag, personContact.get(PersonContactToKvFn.successTag)).and(personNameTag, personName.get(ReadPersonNameFn.successTag)).apply(CoGroupByKey.<String> create());
