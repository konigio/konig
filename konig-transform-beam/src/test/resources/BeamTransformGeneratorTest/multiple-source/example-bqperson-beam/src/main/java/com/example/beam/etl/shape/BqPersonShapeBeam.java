...
public class BqPersonShapeBeam {
    ...
    public static void process(BqPersonShapeBeam.Options options) {
        ...
        PCollection personAlumniOf = p.apply(org.apache.beam.sdk.io.gcp.bigquery.BigQueryIO.readTableRows().from(PersonAlumniOfShapeTableRef));
        PCollectionTuple personAlumniOfOutputTuple = PCollectionTuple.of(personAlumniOfTag, personAlumniOf);
        ...
        PCollection<KV<String, CoGbkResult>> kvpCollection = KeyedPCollectionTuple.of(personAlumniOfTag, personAlumniOfOutputTuple).and(personNameTag, personName).apply(CoGroupByKey.<String> create());
