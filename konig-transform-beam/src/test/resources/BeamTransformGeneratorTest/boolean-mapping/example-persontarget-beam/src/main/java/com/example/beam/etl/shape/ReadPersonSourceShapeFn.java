    ...
    extends DoFn<FileIO.ReadableFile, com.google.api.services.bigquery.model.TableRow>
{
            ...
            try {
                ...
                for (CSVRecord record: csv) {
                    ...
                    try {
                        ...
                        Long dummy_flag = longValue(csv, "dummy_flag", record, builder);
                        if (dummy_flag!= null) {
                            row.set("dummy_flag", dummy_flag);
                        }
    ...
    private void validateHeaders(CSVParser csv) {
        ...
        StringBuilder builder = new StringBuilder();
        validateHeader(headerMap, "dummy_flag", builder);
    ...
    private Long longValue(CSVParser csv,
        String fieldName,
        CSVRecord record,
                ...
                if (stringValue!= null) {
                    ...
                    if (stringValue.length()> 0) {
                        try {
                            ...
                            String message = String.format("Invalid long value for %s;", fieldName);
