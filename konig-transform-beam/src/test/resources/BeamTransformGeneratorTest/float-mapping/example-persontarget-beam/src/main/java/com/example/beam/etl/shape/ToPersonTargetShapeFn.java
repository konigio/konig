    ...
    extends DoFn<TableRow, TableRow>
{
    ...
    private Float heightInches(ErrorBuilder errorBuilder, TableRow personTargetRow, TableRow personSourceRow) {
        Float heightInches = ((Float) personSourceRow.get("person_height"));
