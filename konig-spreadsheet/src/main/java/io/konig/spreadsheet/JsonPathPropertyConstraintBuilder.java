...
public class JsonPathPropertyConstraintBuilder {
	...
	public JsonPathPropertyConstraintBuilder(ShapeManager shapeManager, SettingsSheet settings) {
	...
	private String propertyNamespace() {
		return settings.getPropertyBaseURL();
	}
