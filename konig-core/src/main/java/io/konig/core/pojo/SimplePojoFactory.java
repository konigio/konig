...
public class SimplePojoFactory implements PojoFactory {
	...
	public SimplePojoFactory(PojoContext config) {
		this.config = config;
	}
	...
	public void createAll(Graph graph) throws KonigException {
		...
		private class PropertyInfo {
			...
			void set(SimplePojoFactory worker, Graph g, Object instance, Value value) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException, InstantiationException {
			 ...
			 * @param object
			 */
			private void setInverse(SimplePojoFactory worker, Object subject, Object object) {
