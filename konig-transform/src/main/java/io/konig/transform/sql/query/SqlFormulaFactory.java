...
public class SqlFormulaFactory {
	...
	public ValueExpression formula(TableName sourceTable, PropertyConstraint p) throws ShapeTransformException {
	...
	private static class Worker {
		...
		public Worker(TableName sourceTable) {
			this.sourceTable = sourceTable;
		}

		public ValueExpression formula(PropertyConstraint p) throws ShapeTransformException {
			
			
			Expression source = p.getFormula();
			if (source == null) {
				throw new ShapeTransformException("The 'formula' must be defined for property " + p.getPredicate().stringValue());
			}
			...
			try {
				...
				throw new ShapeTransformException("Failed to generate formula for property " +
