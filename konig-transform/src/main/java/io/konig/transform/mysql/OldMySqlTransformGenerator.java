...
public class OldMySqlTransformGenerator implements ShapeHandler {
	...
	public OldMySqlTransformGenerator(ShapeManager shapeManager, File outDir, OwlReasoner owlReasoner) {
	...
	public OldMySqlTransformGenerator(ShapeManager shapeManager, File outDir, ShapeRuleFactory shapeRuleFactory) {
