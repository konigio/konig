...
public class JoinExpression0 extends AbstractExpression implements TableItemExpression {
	
	private TableItemExpression leftTable;
	private TableItemExpression rightTable;
	private OnExpression joinSpecification;

	public JoinExpression0(TableItemExpression leftTable, TableItemExpression rightTable,
	...
	public void print(PrettyPrintWriter out) {
		...
		if (joinSpecification!=null) {
			...
			if (rightTable instanceof JoinExpression0) {
